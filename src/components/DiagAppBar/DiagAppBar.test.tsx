...
describe("DiagAppBar Component", () => {
  it("should render the AppBar with the correct title and buttons", () => {
    render(<DiagAppBar selectedPage={pages[0]} pages={pages} onPageChange={vi.fn()} />);
  ...
  it("should call onPageChange when a button is clicked", () => {
    ...
    render(<DiagAppBar selectedPage={pages[0]} pages={pages} onPageChange={onPageChangeMock} />);
  ...
  it("should highlight the active page button", () => {
    const onPageChangeMock = vi.fn();
    const { rerender } = render(<DiagAppBar selectedPage={pages[0]} pages={pages} onPageChange={onPageChangeMock} />);
    ...
    rerender(<DiagAppBar selectedPage={pages[1]} pages={pages} onPageChange={onPageChangeMock} />);
